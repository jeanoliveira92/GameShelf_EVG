			...
			<div class="col-md-12">	
				<div class="row nopadding">						
					<div id="top" class="row nopadding">
							<h2 style="margin-top: 50px;">Meus Favoritos</h2>
					</div> <!-- /#top -->
				</div>
				<div class="row nopadding">
					<?php
					...
					<div id='list' class='row nopadding'>
						<table class='table table-hover'>
							...
							$result = mysql_query("select * from favoritos where userId=$_SESSION[id] LIMIT $inicio, $limite"); 
							...
							*/
							...
							while ($row = mysql_fetch_array($result)){
								...
								echo   "<tr>
											...
											<a class='btn btn-danger btn-xs'  href='removerFavoritos.php?id=$row[gamesId]'"; ?> onclick="return confirm('Deseja remover realmente?')">Excluir</a>
								<?php
								echo "</td>";
								echo "</tr>";
					...
					<div id='bottom' class='row'>
						<div class='col-md-8 col-md-offset-3'>			 
							...
							$sql = "select * from favoritos where userId=$_SESSION[id]";
