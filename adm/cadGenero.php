				...
				<?php include("left-sidebar.php"); ?>
					<div class="col-md-9">
						<div class="col-md-12">
							...
							<?php	if(isset($id)){	echo "action='cadastraGenero.php?opt=update&id=$_GET[id]'";}
									else{			echo "action='cadastraGenero.php'";}						
							?>>
							<?php
							if(isset($id)){
								echo "
								<fieldset class='form-group'>
									...
									<div class='row'>
										...
										<div class='form-group col-md-5'>
											  ...
											  <textarea class='form-control' rows='5' id='descricao' name ='descricao' required>$dados[descricao]
											</textarea>
										</div>
									</div>	
								</fieldset>		
								...
								echo "<fieldset class='form-group'>
									...
									<div class='row'>
										...
										<div class='form-group col-md-5'>
											  <label for='descricao'>Descricao:</label>
											  <textarea class='form-control' rows='5' name ='descricao' id='descricao' required>
											</textarea>
										</div>
									</div>	
								</fieldset>			
