					...
					<div class="col-md-9">
						<div class="col-md-12">
							<div id="top" class="row">
								<div class="col-md-4">
									<h2>Consultar Games</h2>
								</div>
								<div class="col-md-6">
									<form class="form" id="userlistform" name="userlistform" action="consulgame.php" method="get">
								...
								<div class="col-md-2">
									<a href="cadgame.php" class="btn btn-primary pull-right h2">Novo Game</a>
								</div>
							 </div> <!-- /#top -->
							 ...
							 <?php
								...
								if(isset($_GET['nome'])){
									...
									{ 
										...
										echo "	<a class='btn btn-success btn-xs' href='vistgame.php?id=".$row['id']."'>Visualizar</a>";
										echo "	<a class='btn btn-warning btn-xs' href='cadgame.php?id=".$row['id']."'>Editar</a>";
									...
									if($pag != 1){
										echo "href='consulgame.php?pag=1&nome=$nome'";
									}
									...
									if($pag != 1){
										echo "href='consulgame.php?pag=".($pag-1)."&nome=$nome'";
									}
									...
									for($i = $pag-($max_links+($max_links-$fim)); $i <= $pag-1; $i++) { 
										if($i <=0) { //faz nada 
											...
											$ini++;
											echo "<li><a href='consulgame.php?pag=$i&nome=$nome'>$i</a></li>";		
										}
									}
									...
									if($pag < $pags){
										echo "href='consulgame.php?pag=".$pags."&nome=$nome'";
									}	
